                         ...
                         bool is_congested)
{
  ...
  if (block->journal_) {
    ...
    block->journal_->pushParam(owner->getOID());
    block->journal_->pushParam(guide->getOID());
    block->journal_->pushParam(guide->box_.xMin());
    block->journal_->pushParam(guide->box_.yMin());
    block->journal_->pushParam(guide->box_.xMax());
    block->journal_->pushParam(guide->box_.yMax());
    block->journal_->pushParam(guide->layer_);
    block->journal_->pushParam(guide->via_layer_);
    block->journal_->pushParam(guide->is_congested_);
...
void dbGuide::destroy(dbGuide* guide)
{
  ...
  if (block->journal_) {
    ...
    block->journal_->pushParam(_guide->getOID());
